...
public class Num8 {
    public static void main(String[] args) {
        ...
        //8번
        Map<Boolean, Map<Object, Long>> collect = Stream.of(stuArr).collect(Collectors.groupingBy(Student::isMale, Collectors.groupingBy(i -> i.getScore() < 150, Collectors.counting())));
        System.out.println("불합격[남자]: " + collect.get(true).get(true));
        System.out.println("불합격[여자]: " + collect.get(false).get(true));
