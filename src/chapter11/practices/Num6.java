...
public class Num6 {
    static int getGroupCount(TreeSet set, int from, int to) {
        Student2 s1 = new Student2("검사", 0, 0, from, from, from);
        Student2 s2 = new Student2("검사", 0, 0, to, to, to);
        SortedSet sortedSet = set.subSet(s1, s2);
        ...
        TreeSet set = new TreeSet(new Comparator() {
            public int compare(Object o1, Object o2) {
                if(o1 instanceof Student2 && o2 instanceof Student2){
                    ...
                    return (int)(s.getAverage() - s2.getAverage());
                }
                return -1;
            }
        });
